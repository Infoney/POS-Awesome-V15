...
from posawesome.mizan.doctype.pos_closing_shift.closing_processing import creation, overview
...
class TestClosingShiftCashMovementIntegration(unittest.TestCase):
    @patch("posawesome.mizan.doctype.pos_closing_shift.closing_processing.creation.get_payments_entries")
    @patch("posawesome.mizan.doctype.pos_closing_shift.closing_processing.creation.get_pos_invoices")
    @patch("posawesome.mizan.doctype.pos_closing_shift.closing_processing.creation.submit_printed_invoices")
    @patch("posawesome.mizan.doctype.pos_closing_shift.closing_processing.creation.frappe")
    ...
    @patch("posawesome.mizan.doctype.pos_closing_shift.closing_processing.overview.get_payments_entries")
    @patch("posawesome.mizan.doctype.pos_closing_shift.closing_processing.overview.get_pos_invoices")
    @patch("posawesome.mizan.doctype.pos_closing_shift.closing_processing.overview.frappe")
