...
from posawesome.mizan.doctype.pos_closing_shift.closing_processing import invoices, overview
...
class TestPOSClosingShift(unittest.TestCase):
    ...
    @patch("posawesome.mizan.doctype.pos_closing_shift.closing_processing.invoices.frappe")
