...
def _install_stubs():
    ...
    employees_module = types.ModuleType("posawesome.mizan.api.employees")
    ...
    sys.modules["posawesome.mizan.api.employees"] = employees_module
...
def _load_module():
    module_name = "posawesome.mizan.api.gift_cards"
