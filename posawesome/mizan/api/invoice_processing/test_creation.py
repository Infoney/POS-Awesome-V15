...
def _install_dependency_stubs():
    ...
    processing_utils = types.ModuleType("posawesome.mizan.api.invoice_processing.utils")
    ...
    sys.modules["posawesome.mizan.api.invoice_processing.utils"] = processing_utils

    stock_module = types.ModuleType("posawesome.mizan.api.invoice_processing.stock")
    ...
    sys.modules["posawesome.mizan.api.invoice_processing.stock"] = stock_module

    payment_utils_module = types.ModuleType("posawesome.mizan.api.payment_processing.utils")
    payment_utils_module.get_bank_cash_account = lambda *_args, **_kwargs: None
    sys.modules["posawesome.mizan.api.payment_processing.utils"] = payment_utils_module

    utilities_module = types.ModuleType("posawesome.mizan.api.utilities")
    ...
    sys.modules["posawesome.mizan.api.utilities"] = utilities_module

    payments_module = types.ModuleType("posawesome.mizan.api.payments")
    payments_module.redeeming_customer_credit = lambda *_args, **_kwargs: None
    sys.modules["posawesome.mizan.api.payments"] = payments_module
...
def _install_package_stubs():
    package_paths = {
        ...
        "posawesome.mizan.api.invoice_processing": (
...
def _load_module():
    module_name = "posawesome.mizan.api.invoice_processing.creation"
...
class TestPostSubmitPaymentProcessing(unittest.TestCase):
    ...
    def test_run_post_submit_payments_passes_created_receive_entries_to_change_entry_creation(self):
        ...
        payment_module_name = "posawesome.mizan.api.invoice_processing.payment"
    ...
    def test_apply_invoice_gift_card_settlement_delegates_before_submit(self):
        ...
        gift_card_module_name = "posawesome.mizan.api.gift_cards"
        gift_card_calls = []
