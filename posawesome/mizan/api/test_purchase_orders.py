...
def _install_stubs():
	...
	posawesome_inner_pkg = types.ModuleType("posawesome.mizan")
	posawesome_inner_pkg.__path__ = [str(REPO_ROOT / "posawesome" / "posawesome")]
	sys.modules.setdefault("posawesome.mizan", posawesome_inner_pkg)

	posawesome_api_pkg = types.ModuleType("posawesome.mizan.api")
	posawesome_api_pkg.__path__ = [str(REPO_ROOT / "posawesome" / "posawesome" / "api")]
	sys.modules.setdefault("posawesome.mizan.api", posawesome_api_pkg)
...
def _load_module():
	module_name = "posawesome.mizan.api.purchase_orders"
