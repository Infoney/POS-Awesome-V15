...
def _install_dependency_stubs():
    item_fetchers_module = types.ModuleType("posawesome.mizan.api.item_fetchers")
    item_fetchers_module.ItemDetailAggregator = object
    item_fetchers_module.get_batches = lambda *args, **kwargs: []
    sys.modules["posawesome.mizan.api.item_fetchers"] = item_fetchers_module
    ...
    utils_module = types.ModuleType("posawesome.mizan.api.utils")
    ...
    sys.modules["posawesome.mizan.api.utils"] = utils_module
...
def _install_package_stubs():
    package_paths = {
        ...
        "posawesome.mizan.api.item_processing": (
...
def _load_module():
    module_name = "posawesome.mizan.api.item_processing.details"
