...
def _install_frappe_stub():
    ...
    invoice_processing_utils = types.ModuleType(
        "posawesome.mizan.api.invoice_processing.utils"
    )
    ...
    invoice_processing_stock = types.ModuleType(
        "posawesome.mizan.api.invoice_processing.stock"
    )
    ...
    invoice_processing_creation = types.ModuleType(
        "posawesome.mizan.api.invoice_processing.creation"
    )
    ...
    invoice_processing_returns = types.ModuleType(
        "posawesome.mizan.api.invoice_processing.returns"
    )
    ...
    invoice_processing_payment = types.ModuleType(
        "posawesome.mizan.api.invoice_processing.payment"
    )
    ...
    invoice_processing_data = types.ModuleType(
        "posawesome.mizan.api.invoice_processing.data"
    )
...
def _load_invoices_module():
    module_name = "posawesome.mizan.api.invoices"
