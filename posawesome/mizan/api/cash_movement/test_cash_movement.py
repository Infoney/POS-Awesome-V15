...
from posawesome.mizan.api.cash_movement import queries, service, validation


class TestCashMovementValidation(unittest.TestCase):
    @patch("posawesome.mizan.api.cash_movement.validation.frappe")
...
class TestCashMovementService(unittest.TestCase):
    @patch("posawesome.mizan.api.cash_movement.service.parse_payload")
    @patch("posawesome.mizan.api.cash_movement.service.get_opening_shift")
    @patch("posawesome.mizan.api.cash_movement.service.get_pos_profile")
    @patch("posawesome.mizan.api.cash_movement.service.validate_company_consistency")
    @patch("posawesome.mizan.api.cash_movement.service.ensure_feature_enabled")
    @patch("posawesome.mizan.api.cash_movement.service.ensure_movement_allowed")
    @patch("posawesome.mizan.api.cash_movement.service.validate_amount")
    @patch("posawesome.mizan.api.cash_movement.service.validate_remarks")
    @patch("posawesome.mizan.api.cash_movement.service.ensure_no_duplicate_client_request")
    @patch("posawesome.mizan.api.cash_movement.service.resolve_source_cash_account")
    @patch("posawesome.mizan.api.cash_movement.service.resolve_target_account")
    @patch("posawesome.mizan.api.cash_movement.service.validate_account_company")
    @patch("posawesome.mizan.api.cash_movement.service.create_journal_entry")
    @patch("posawesome.mizan.api.cash_movement.service.frappe")
    ...
    @patch("posawesome.mizan.api.cash_movement.service._create_cash_movement")
    @patch("posawesome.mizan.api.cash_movement.service.ensure_owner_or_manager")
    @patch("posawesome.mizan.api.cash_movement.service.frappe")
...
class TestCashMovementQueries(unittest.TestCase):
    @patch("posawesome.mizan.api.cash_movement.queries.frappe.get_all")
